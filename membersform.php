                        ...
                        // kondisi jika update jenis mahasiswa
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="iduser">
                                    ...
                                    while($dd1 = $cari->fetch_array()){ ?>
                                        <option <?php echo ($dd1['idmhs'] == $dd['iduser']) ? "selected":"";?> value="<?php echo $dd1['idmhs'];?>"><?php echo $dd1['nim']." - ".$dd1['nama'];?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        <?php }
                    ...
                    //kondisi jika insert
                        ...
                        <div class="form-group" id="chooseMahasiswa">
                            ...
                            <select class="form-control" name="iduser">
                                ...
                                $cari = $db->query("SELECT * FROM mahasiswa");
                                while($dd1 = $cari->fetch_array()){ ?>
                                    <option value="<?php echo $dd1['idmhs'];?>"><?php echo $dd1['nim']." - ".$dd1['nama'];?></option>
                                <?php } ?>
                            </select>
                        </div>
                    <?php } ?>
